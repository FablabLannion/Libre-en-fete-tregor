...
<br><a href=\"mailto:presse@libre-en-fete-tregor.fr\">Contact: Camille, Claire, Lise, Katell et Stan</a>"
   ...
   array(
      ...
      "",
      "<ul><li>Initiation à la programmation avec <a href=\"https://scratch.mit.edu/\">Scratch</a>,</li> <li>Ateliers électronique junior</li><li>Initiation à la soudure</li><li>les secrets du numérique avec la Cité des télécoms</li></ul><a href=\"mailto:leny@libre-en-fete-tregor.fr\">Contact: Leny</a>"
   ),
   array(
      "Espace Fablab",
   ...
   array(
      ...
      <ul>
        ...
        <ul>
          <li>Un concours de programmation seul ou par équipe ;</li>
          <li>L'objectif est de proposer une réalisation originale, pendant le temps de l'événement, sur un thème imposé qui sera dévoilé la veille ;</li>
          <li>Inscription préalable obligatoire ;</li> 
          <li>De nombreux lots à gagner ; </li>
          <li>Les personnes de tous les niveaux en programmation ont une chance : le Hackathon c'est aussi trouver un bon concept ;</li> 
