...
$data_2016 = array (
  array("700 Participants",
     "img/2016-1.JPG",
     "",
     "Venus parfois de loin, plus de 700 participants ont répondu présents. Un public très familial, curieux, débutant ou confirmé. Tout le monde a trouvé sa place."
  ),
  array("100 Bénévoles / 20 associations",
     "img/2016-5.JPG",
     "",
  ...
  array("2 Hackathons et 1 concours citoyen",
     "img/2016-2.JPG",
     "",
  ...
  array("7 espaces",
     "img/2016-3.JPG",
     "",
     "Espaces Citoyen, Enfants, Fablab, Multimédia, Pro, Geek"
  ),
  array("Les Sponsors",
     "img/2016-4.JPG",
     "",
...
$data_2018 = array (
  ...
  array("Les 6 espaces",
    "img/2016-3.JPG",
    "",
    "Explorer : numérique & territoire, Comprendre: numérique et enjeux citoyens,
    Jouer, Apprendre, Entreprendre, Découvrir"
  ),
  array("Les Sponsors",
    "img/2016-4.JPG",
    "",
    "Ils nous ont fait confiance !<br>
    Huawei, Orange, Lannion Trégor Communauté, Ville de Lannion, Ixia, Nokia"
  ),
);
Flight::set('data_2018', $data_2018);
